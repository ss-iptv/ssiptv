// JavaScript Documentvar VK_ENTER					= 13;
var VK_PAGE_UP					= 33;
var VK_PAGE_DOWN				= 34;
var VK_LEFT						= 37;
var VK_UP						= 38;
...
function showapps(ch){
	...
	$_("top_app").innerHTML='<div style="width:680px;height:26px;padding:0px 2px 0px 15px;color:#FFFFFF;font-size:22px;background-color: #9C4857;overflow:hidden;">			Рекомендованные приложения		</div>'+html;
...
function shownews(ch){
	...
	{
		var x=ch[index].split("|");
		html+='<div style="margin:3px 0px;border-radius:7px;padding:3px;background-color: #293B49;">'+x[0]+'<br><b>'+x[1]+'</b><br>'+x[3]+'</div>';
